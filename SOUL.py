...
import os #line:5
import time #line:6
bot =telebot .TeleBot ('7173578789:AAE_IF162hHNxlST8riSZAhkb17w2m67CDY')#line:9
ADMIN_IDS ={"1829385401"}#line:12
...
def handle_bgmi (O0O0O000O0O0OOO0O ):#line:133
    ...
    if OO0OOO0O0O0O000OO in allowed_user_ids :#line:135
        if OO0OOO0O0O0O000OO not in ADMIN_IDS and OO0OOO0O0O0O000OO in bgmi_cooldown and (datetime .datetime .now ()-bgmi_cooldown [OO0OOO0O0O0O000OO ]).seconds <COOLDOWN_TIME :#line:136
            bot .reply_to (O0O0O000O0O0OOO0O ,"You are on cooldown. Please wait 3 minutes before running the /bgmi command again.")#line:137
            return #line:138
...
Buy From :- @Manish_15NoobCRACKER, @Manish_15NoobCRACKER
Official Channel :- t.me/Manish_15NoobCRACKER'''#line:189
